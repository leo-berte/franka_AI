...
def axis_angle_geodesic_error(a1: torch.Tensor, a2: torch.Tensor) -> torch.Tensor:
    """
    Geodesic rotation error between two axis-angle representations.

    Returns:
        (...,) tensor of rotation errors in radians
    """
    q1 = axis_angle_to_quaternion(a1)
    q2 = axis_angle_to_quaternion(a2)
    return quaternion_geodesic_error(q1, q2)


def quaternion_geodesic_error(q1: torch.Tensor, q2: torch.Tensor) -> torch.Tensor:
    """
    Geodesic rotation error between two quaternions.
...
def matrix_to_quaternion(matrix: torch.Tensor) -> torch.Tensor:
    ...
    Returns:
        quaternions with (w, x, y, z), as tensor of shape (..., 4).
    """
