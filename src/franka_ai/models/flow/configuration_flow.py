...
class FlowConfig(PreTrainedConfig):
    ...
    crop_pos: tuple[int, int] | None = None
    random_crop_shape: tuple[int, int] | None = None
    ...
    # Model.
    model: str = "mlp"
    mlp_dims: tuple[int, ...] = (512, 1024, 2048)
    mmDiT_dim = 1024
    mmDiT_nb_blocks = 2

    # Noise scheduler.
    noise_scheduler_type: str = "linear"
    ...
    def __post_init__(self):
        ...
        supported_noise_schedulers = ["linear"]
